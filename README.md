...
<!-- LATEST_RELEASE -->**Latest release:** [v0.4.1](https://github.com/razinkele/ESTAS-AQUABC/releases/tag/v0.4.1)<!-- /LATEST_RELEASE --> · full history in [CHANGELOG.md](CHANGELOG.md)
