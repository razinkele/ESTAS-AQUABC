...
<!-- LATEST_RELEASE -->**Latest release:** [v0.3.8](https://github.com/razinkele/ESTAS-AQUABC/releases/tag/v0.3.8)<!-- /LATEST_RELEASE --> · full history in [CHANGELOG.md](CHANGELOG.md)
