        ...
        MODULE DBGSTR_PEL_DET_PART_ORG_C_01__genmod
          INTERFACE 
            SUBROUTINE DBGSTR_PEL_DET_PART_ORG_C_01(PROCESS_RATES,      &
     &DERIVATIVES,FLAGS,TIME,NKN,NSTATE,NFLAGS,NDIAGVAR,NODE_ACTIVE,    &
     &ERROR)
              INTEGER(KIND=4), INTENT(IN) :: NDIAGVAR
              INTEGER(KIND=4), INTENT(IN) :: NFLAGS
     ...
     &NDIAGVAR)
          ...
          END INTERFACE 
        END MODULE DBGSTR_PEL_DET_PART_ORG_C_01__genmod
