        ...
        MODULE WRITE_PELAGIC_OUTPUT__genmod
          INTERFACE 
            SUBROUTINE WRITE_PELAGIC_OUTPUT(PELAGIC_BOX_MODEL_DATA,TIME,&
     &RES_OUTPUT_UNIT,WRITE_SAVED_OUTPUT,WRITE_PELAGIC_EXERGY_OUTPUT,   &
     &MODEL_AT_INIT)
     ...
     &PELAGIC_BOX_MODEL_DATA
          ...
          END INTERFACE 
        END MODULE WRITE_PELAGIC_OUTPUT__genmod
