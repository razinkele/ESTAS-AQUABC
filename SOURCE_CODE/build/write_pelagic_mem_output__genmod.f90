        ...
        MODULE WRITE_PELAGIC_MEM_OUTPUT__genmod
          INTERFACE 
            SUBROUTINE WRITE_PELAGIC_MEM_OUTPUT(PELAGIC_BOX_MODEL_DATA, &
     &RES_OUTPUT_UNIT,NUM_LINES)
     ...
     &PELAGIC_BOX_MODEL_DATA
          ...
          END INTERFACE 
        END MODULE WRITE_PELAGIC_MEM_OUTPUT__genmod
