        ...
        MODULE DBGSTR_PEL_DET_CH4_C_01__genmod
          INTERFACE 
            SUBROUTINE DBGSTR_PEL_DET_CH4_C_01(PROCESS_RATES,DERIVATIVES&
     &,FLAGS,TIME,NKN,NSTATE,NFLAGS,NDIAGVAR,NODE_ACTIVE,ERROR)
     ...
     &NDIAGVAR)
          ...
          END INTERFACE 
        END MODULE DBGSTR_PEL_DET_CH4_C_01__genmod
