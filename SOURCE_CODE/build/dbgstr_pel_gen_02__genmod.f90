        ...
        MODULE DBGSTR_PEL_GEN_02__genmod
          INTERFACE 
            SUBROUTINE DBGSTR_PEL_GEN_02(PROCESS_RATES,DERIVATIVES,FLAGS&
     &,TIME,NKN,NSTATE,NFLAGS,NDIAGVAR,NODE_ACTIVE,ERROR)
     ...
     &NDIAGVAR)
          ...
          END INTERFACE 
        END MODULE DBGSTR_PEL_GEN_02__genmod
