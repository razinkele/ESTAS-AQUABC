        ...
        MODULE DBGSTR_PEL_DET_TOT_ALK_01__genmod
          INTERFACE 
            SUBROUTINE DBGSTR_PEL_DET_TOT_ALK_01(PROCESS_RATES,         &
     &DERIVATIVES,PH,FLAGS,TIME,NKN,NSTATE,NFLAGS,NDIAGVAR,NODE_ACTIVE, &
     &ERROR)
     ...
     &NDIAGVAR)
          ...
          END INTERFACE 
        END MODULE DBGSTR_PEL_DET_TOT_ALK_01__genmod
