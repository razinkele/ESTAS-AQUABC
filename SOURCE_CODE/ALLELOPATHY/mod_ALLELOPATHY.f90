module ALLELOPATHY
    ...
    real(kind = DBL_ALLEL) :: S_SEC_METAB_TO_DIAC
    real(kind = DBL_ALLEL) :: S_SEC_METAB_TO_NOFIX_CYNC
    real(kind = DBL_ALLEL) :: S_SEC_METAB_TO_FIX_CYNC
    real(kind = DBL_ALLEL) :: S_SEC_METAB_TO_NOSTC
