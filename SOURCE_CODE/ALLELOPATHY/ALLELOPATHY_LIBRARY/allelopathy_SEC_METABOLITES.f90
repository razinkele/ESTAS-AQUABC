...
subroutine allelopathy_SEC_METABOLITES(nkn)
    ...
    R_FORM_SEC_METAB_DIA       = S_SEC_METAB_TO_DIAC       * ALLEL_R_DEATH_DIA
    R_FORM_SEC_METAB_NOFIX_CYN = S_SEC_METAB_TO_NOFIX_CYNC * ALLEL_R_DEATH_NOFIX_CYN
    R_FORM_SEC_METAB_FIX_CYN   = S_SEC_METAB_TO_FIX_CYNC   * ALLEL_R_DEATH_FIX_CYN
    R_FORM_SEC_METAB_NOST      = S_SEC_METAB_TO_NOSTC      * ALLEL_R_DEATH_NOST
